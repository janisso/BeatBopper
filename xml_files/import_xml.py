...
file_name = music21.converter.parse('/Users/mb/Desktop/Janis.so/06_qmul/BeatBopper/xml_files/M07-1/M07-1.musicxml')
...
for i, section in enumerate(sections):
    fp = section.write('xml', fp='/Users/mb/Desktop/Janis.so/06_qmul/BeatBopper/xml_files/M07-1/section_'+str(i)+'.xml')
    fp = section.write('midi',
					   fp='/Users/mb/Desktop/Janis.so/06_qmul/BeatBopper/xml_files/M07-1/section_' + str(i) + '.mid')