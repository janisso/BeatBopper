...
tempo_data = np.genfromtxt(path+'beat_time/M07-1beat_time.csv',delimiter=',',skip_header=1,names=None)[:13,2:]
loud_data = np.genfromtxt(path+'beat_dyn/M07-1beat_dynNORM.csv',delimiter=',',skip_header=1,names=None)[:13,2:]
...
f.suptitle('Average IOIs and Loudness')
...
#np.savetxt("/Users/mb/Desktop/Janis.so/06_qmul/BeatBopper/midi_files/maz_op7_no1_e1/maz_op7_no1_e1.csv", expr_perf, delimiter=",")
...
#np.savetxt("/Users/mb/Desktop/Janis.so/06_qmul/BeatBopper/midi_files/maz_op7_no1_e1/maz_op7_no1_e1countoff.csv", t_bvals, delimiter=",")
